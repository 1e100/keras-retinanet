...
class OpenImagesGenerator(Generator):
    ...
    def __filter_data(
        self, id_to_labels, cls_index, labels_filter=None, parent_label=None
    ):
        """
        ...
        if parent_label is None:
            ...
            if parent_tree is None:
                raise Exception(
                    "Couldnt find parent {} in the semantic hierarchical tree".format(
                        parent_label
                    )
                )
